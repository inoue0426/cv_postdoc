...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}
        ...
        \item IEEE/ACM Transactions on Computational Biology and Bioinformatics (2025--2026)
...
\begin{itemize}[leftmargin=*]
    ...
    \textit{Health Data Science}. Accepted.
...
\begin{itemize}[leftmargin=*]
    ...
    drGT and DrugAgent [Oral presentations].
    \textit{International Conference on Intelligent Systems for Molecular Biology (ISMB)}, Washington, DC.
    Two accepted oral presentations in NetBio and Text Mining; both also presented at the Student Council Symposium.
...
\vspace{1em}
\begin{itemize}[leftmargin=*]
    \item[] NIH Pre-Doctoral Research Fellowship \hfill 2024 -- Present
    \item[] Outstanding Postgraduate Fellow Finalist, 26th Annual CCR-FYI Colloquium \hfill 2026
    \item[] Research Visit Scholarships, NAIST and JASSO \hfill 2018 -- 2019
\end{itemize}
