...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}
        \item Developing machine learning methods for biological perturbation modeling and therapeutic response prediction.
        \item Working across single-cell, pharmacogenomic, high-throughput screening, cancer cell-line, and patient datasets.
        \item Developing treatment-conditioned latent-state transition models, graph-based drug-response models, and biomedical reasoning systems.
    \end{itemize}

    \item[] \textbf{Google Summer of Code Contributor; Mentor}, Google Summer of Code \hfill 2022 -- 2024
    \begin{itemize}
        \item Developed a drug-response prediction pipeline and mentored projects involving PyTorch Geometric datasets and multi-tool LLM aggregation.
    \end{itemize}
...
\begin{itemize}[leftmargin=*]
    ...
    \textit{arXiv}. Submitted to ICLR 2027.
...
\begin{itemize}[leftmargin=*]
    ...
    \item[] \textbf{Inoue, Y.} (2026).
    drGT [Oral presentation].
    \textit{ISMB Student Council Symposium}, Washington, DC.
...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}
        \item BMJ Digital Health \& AI (Expert Peer Reviewer, 2026--2027)
        \item IEEE/ACM Transactions on Computational Biology and Bioinformatics (2025--2027)
        \item Nature Computational Science (co-reviewer, 2026)
    \end{itemize}

    \item[] \textbf{Conference reviewing}
    \begin{itemize}
        \item ACM BCB (2023); ICML FM4LS (2026); ICML GenBio (2026); IEEE BIBM (2026); ACM SIGSPATIAL (2026)
    \end{itemize}
\end{itemize}
...
Graph neural networks and heterogeneous graphs;
autoencoders and latent-state models;
representation learning;
domain adaptation and transfer learning;
treatment-conditioned transition modeling;
LLM-based agents and retrieval-augmented generation;
interpretable machine learning.

\item[] \textbf{Computational Biology:}
Single-cell and bulk RNA-seq;
pharmacogenomics and drug-response modeling;
...
PyTorch; PyTorch Geometric; scikit-learn; pandas; NumPy; SciPy; LangChain; AutoGen.

\item[] \textbf{Computational Infrastructure:}
Linux; Git / GitHub; Slurm; HPC; GPU computing; CUDA; Bash; SSH / remote development; Docker; uv; Ollama; LightLLM.
...
\vspace{1em}
\begin{itemize}[leftmargin=*]
    \item[] NIH Predoctoral Research Fellowship (\$54,000/year) \hfill 2024--Present
    \item[] Outstanding Postgraduate Fellow Finalist, 26th Annual CCR-FYI Colloquium \hfill 2026
    \item[] Research Visit Scholarships, NAIST and JASSO (\$6,000) \hfill 2018 -- 2019
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    ...
    \item[] American Association for Cancer Research (AACR)
    \item[] American Society of Clinical Oncology (ASCO)
\end{itemize}
